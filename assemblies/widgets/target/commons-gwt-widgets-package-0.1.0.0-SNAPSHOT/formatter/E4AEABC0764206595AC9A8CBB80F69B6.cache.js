...
var $strongName = 'E4AEABC0764206595AC9A8CBB80F69B6';
var $gwt = {};
...
function getFormat(predef){
  ...
  switch (predef.ordinal) {
    ...
    case 5:
      ...
      break;
    case 10:
      pattern = 'EEEE d. MMMM y HH:mm:ss zzzz';
      break;
    case 11:
      pattern = "d. MMMM y 'kl'. HH:mm:ss z";
      break;
    case 12:
...
function $getDateTimeFormatInfo(this$static){
  !this$static.dateTimeFormatInfo && (this$static.dateTimeFormatInfo = new DateTimeFormatInfoImpl_nb);
  return this$static.dateTimeFormatInfo;
}

function $getNumberConstants(this$static){
  !this$static.numberConstants && (this$static.numberConstants = new NumberConstantsImpl_no);
...
function NumberConstantsImpl_no(){
}

defineClass(63, 1, {}, NumberConstantsImpl_no);
var Lcom_google_gwt_i18n_client_constants_NumberConstantsImpl_1no_2_classLit = createForClass('com.google.gwt.i18n.client.constants', 'NumberConstantsImpl_no', 63);
...
function DateTimeFormatInfoImpl_nb(){
}

defineClass(62, 91, {}, DateTimeFormatInfoImpl_nb);
...
_.erasFull = function erasFull_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['f\xF8r Kristus', 'etter Kristus']);
}
;
...
_.monthsFull = function monthsFull_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['januar', 'februar', 'mars', 'april', 'mai', 'juni', 'juli', 'august', 'september', 'oktober', 'november', 'desember']);
}
;
_.monthsShort = function monthsShort_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['jan.', 'feb.', 'mar.', 'apr.', 'mai', 'jun.', 'jul.', 'aug.', 'sep.', 'okt.', 'nov.', 'des.']);
}
;
...
_.quartersFull = function quartersFull_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['1. kvartal', '2. kvartal', '3. kvartal', '4. kvartal']);
}
;
...
_.weekdaysFull = function weekdaysFull_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['s\xF8ndag', 'mandag', 'tirsdag', 'onsdag', 'torsdag', 'fredag', 'l\xF8rdag']);
}
;
...
_.weekdaysShort = function weekdaysShort_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['s\xF8n.', 'man.', 'tir.', 'ons.', 'tor.', 'fre.', 'l\xF8r.']);
}
;
var Lcom_google_gwt_i18n_client_impl_cldr_DateTimeFormatInfoImpl_1nb_2_classLit = createForClass('com.google.gwt.i18n.client.impl.cldr', 'DateTimeFormatInfoImpl_nb', 62);
...
function JSNumberTextFormatter(pattern){
  this.formatter = ($clinit_NumberFormat() , new NumberFormat_0(pattern, ['NOK', 'kr', 2, 'NOkr', 'kr']));
...
setGwtProperty('permProps', [[['locale', 'no'], ['user.agent', 'gecko1_8']]]);
