...
var $strongName = 'FA6A37C908D7FC5769ACF6777B6828E8';
var $gwt = {};
...
function getFormat(predef){
  ...
  switch (predef.ordinal) {
    ...
    case 5:
      ...
      break;
    case 10:
      pattern = "EEEE d MMMM y '\xE0' HH:mm:ss zzzz";
      break;
    case 11:
      pattern = "d MMMM y '\xE0' HH:mm:ss z";
      break;
    case 12:
      pattern = "d MMM y '\xE0' HH:mm:ss";
      break;
    case 13:
...
function $getDateTimeFormatInfo(this$static){
  !this$static.dateTimeFormatInfo && (this$static.dateTimeFormatInfo = new DateTimeFormatInfoImpl_fr);
  return this$static.dateTimeFormatInfo;
}

function $getNumberConstants(this$static){
  !this$static.numberConstants && (this$static.numberConstants = new NumberConstantsImpl_fr);
...
function NumberConstantsImpl_fr(){
}

defineClass(63, 1, {}, NumberConstantsImpl_fr);
var Lcom_google_gwt_i18n_client_constants_NumberConstantsImpl_1fr_2_classLit = createForClass('com.google.gwt.i18n.client.constants', 'NumberConstantsImpl_fr', 63);
...
function DateTimeFormatInfoImpl_fr(){
}

defineClass(62, 91, {}, DateTimeFormatInfoImpl_fr);
_.erasFull = function erasFull_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['avant J\xE9sus-Christ', 'apr\xE8s J\xE9sus-Christ']);
}
;
_.erasShort = function erasShort_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['av. J.-C.', 'ap. J.-C.']);
}
;
_.monthsFull = function monthsFull_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['janvier', 'f\xE9vrier', 'mars', 'avril', 'mai', 'juin', 'juillet', 'ao\xFBt', 'septembre', 'octobre', 'novembre', 'd\xE9cembre']);
}
;
_.monthsShort = function monthsShort_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['janv.', 'f\xE9vr.', 'mars', 'avr.', 'mai', 'juin', 'juil.', 'ao\xFBt', 'sept.', 'oct.', 'nov.', 'd\xE9c.']);
}
;
_.quartersFull = function quartersFull_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['1er trimestre', '2e trimestre', '3e trimestre', '4e trimestre']);
}
;
...
_.weekdaysFull = function weekdaysFull_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['dimanche', 'lundi', 'mardi', 'mercredi', 'jeudi', 'vendredi', 'samedi']);
}
;
_.weekdaysNarrow = function weekdaysNarrow_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['D', 'L', 'M', 'M', 'J', 'V', 'S']);
}
;
_.weekdaysShort = function weekdaysShort_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['dim.', 'lun.', 'mar.', 'mer.', 'jeu.', 'ven.', 'sam.']);
}
;
var Lcom_google_gwt_i18n_client_impl_cldr_DateTimeFormatInfoImpl_1fr_2_classLit = createForClass('com.google.gwt.i18n.client.impl.cldr', 'DateTimeFormatInfoImpl_fr', 62);
...
setGwtProperty('permProps', [[['locale', 'fr'], ['user.agent', 'safari']]]);
