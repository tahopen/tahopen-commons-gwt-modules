...
var $strongName = '872BCBF100ACCB22BE9A62D06D4E1E0D';
var $gwt = {};
...
function getFormat(predef){
  ...
  switch (predef.ordinal) {
    ...
    case 5:
      ...
      break;
    case 10:
      pattern = 'EEEE\u060C d MMMM y h:mm:ss a zzzz';
      break;
    case 11:
      pattern = 'd MMMM y h:mm:ss a z';
      break;
    case 12:
      pattern = 'dd\u200F/MM\u200F/y h:mm:ss a';
      break;
    case 13:
      pattern = 'd\u200F/M\u200F/y h:mm a';
      break;
    case 14:
      pattern = 'd';
      break;
...
function $getDateTimeFormatInfo(this$static){
  !this$static.dateTimeFormatInfo && (this$static.dateTimeFormatInfo = new DateTimeFormatInfoImpl_ar);
  return this$static.dateTimeFormatInfo;
}

function $getNumberConstants(this$static){
  !this$static.numberConstants && (this$static.numberConstants = new NumberConstantsImpl_ar);
...
function $format_1(this$static, isNegative, digits, scale){
  ...
  zeroChar = (checkCriticalStringElementIndex(0, '\u0660'.length) , '\u0660'.charCodeAt(0));
...
function $parse_2(this$static, text_0, inOutPos){
  ...
  if ($equals(valueOnly, '\u221E')) {
   ...
   else if ($equals(valueOnly, '\u0644\u064A\u0633\xA0\u0631\u0642\u0645')) {
    inOutPos[0] += '\u0644\u064A\u0633\xA0\u0631\u0642\u0645'.length;
    ret = NaN;
  }
   else {
...
function $parseNumber(this$static, text_0, pos){
  ...
  for (; pos[0] < text_0.length; ++pos[0]) {
    ...
    if (digit >= 0 && digit <= 9) {
     ...
     else if (ch_0 == (checkCriticalStringElementIndex(0, '\u0627\u0633'.length) , '\u0627\u0633'.charCodeAt(0))) {
      if (sawExponent) {
        break;
      }
...
function NumberConstantsImpl_ar(){
}

defineClass(63, 1, {}, NumberConstantsImpl_ar);
var Lcom_google_gwt_i18n_client_constants_NumberConstantsImpl_1ar_2_classLit = createForClass('com.google.gwt.i18n.client.constants', 'NumberConstantsImpl_ar', 63);
...
defineClass(62, 91, {}, DateTimeFormatInfoImpl_ar);
_.ampms = function ampms_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['\u0635', '\u0645']);
}
;
_.erasFull = function erasFull_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['\u0642\u0628\u0644 \u0627\u0644\u0645\u064A\u0644\u0627\u062F', '\u0645\u064A\u0644\u0627\u062F\u064A']);
}
;
_.erasShort = function erasShort_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['\u0642.\u0645', '\u0645']);
}
;
_.monthsFull = function monthsFull_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['\u064A\u0646\u0627\u064A\u0631', '\u0641\u0628\u0631\u0627\u064A\u0631', '\u0645\u0627\u0631\u0633', '\u0623\u0628\u0631\u064A\u0644', '\u0645\u0627\u064A\u0648', '\u064A\u0648\u0646\u064A\u0648', '\u064A\u0648\u0644\u064A\u0648', '\u0623\u063A\u0633\u0637\u0633', '\u0633\u0628\u062A\u0645\u0628\u0631', '\u0623\u0643\u062A\u0648\u0628\u0631', '\u0646\u0648\u0641\u0645\u0628\u0631', '\u062F\u064A\u0633\u0645\u0628\u0631']);
}
;
_.monthsNarrow = function monthsNarrow_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['\u064A', '\u0641', '\u0645', '\u0623', '\u0648', '\u0646', '\u0644', '\u063A', '\u0633', '\u0643', '\u0628', '\u062F']);
}
;
...
_.quartersFull = function quartersFull_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['\u0627\u0644\u0631\u0628\u0639 \u0627\u0644\u0623\u0648\u0644', '\u0627\u0644\u0631\u0628\u0639 \u0627\u0644\u062B\u0627\u0646\u064A', '\u0627\u0644\u0631\u0628\u0639 \u0627\u0644\u062B\u0627\u0644\u062B', '\u0627\u0644\u0631\u0628\u0639 \u0627\u0644\u0631\u0627\u0628\u0639']);
}
;
...
_.weekdaysFull = function weekdaysFull_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['\u0627\u0644\u0623\u062D\u062F', '\u0627\u0644\u0627\u062B\u0646\u064A\u0646', '\u0627\u0644\u062B\u0644\u0627\u062B\u0627\u0621', '\u0627\u0644\u0623\u0631\u0628\u0639\u0627\u0621', '\u0627\u0644\u062E\u0645\u064A\u0633', '\u0627\u0644\u062C\u0645\u0639\u0629', '\u0627\u0644\u0633\u0628\u062A']);
}
;
_.weekdaysNarrow = function weekdaysNarrow_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['\u062D', '\u0646', '\u062B', '\u0631', '\u062E', '\u062C', '\u0633']);
}
;
...
;
var Lcom_google_gwt_i18n_client_impl_cldr_DateTimeFormatInfoImpl_1ar_2_classLit = createForClass('com.google.gwt.i18n.client.impl.cldr', 'DateTimeFormatInfoImpl_ar', 62);
...
function JSNumberTextFormatter(pattern){
  this.formatter = ($clinit_NumberFormat() , new NumberFormat_0(pattern, ['EGP', '\u062C.\u0645.', 2, 'LE', 'E\xA3']));
...
setGwtProperty('permProps', [[['locale', 'ar'], ['user.agent', 'gecko1_8']]]);
