...
var $strongName = '5133B0AF0A816ECDEF833E29785453FF';
var $gwt = {};
...
function getFormat(predef){
  ...
  switch (predef.ordinal) {
    ...
    case 5:
      ...
      break;
    case 10:
      pattern = "EEEE d MMMM y 'om' HH:mm:ss zzzz";
      break;
    case 11:
      pattern = "d MMMM y 'om' HH:mm:ss z";
      break;
    case 12:
...
function $getDateTimeFormatInfo(this$static){
  !this$static.dateTimeFormatInfo && (this$static.dateTimeFormatInfo = new DateTimeFormatInfoImpl_nl);
  return this$static.dateTimeFormatInfo;
}

function $getNumberConstants(this$static){
  !this$static.numberConstants && (this$static.numberConstants = new NumberConstantsImpl_nl);
...
function NumberConstantsImpl_nl(){
}

defineClass(63, 1, {}, NumberConstantsImpl_nl);
var Lcom_google_gwt_i18n_client_constants_NumberConstantsImpl_1nl_2_classLit = createForClass('com.google.gwt.i18n.client.constants', 'NumberConstantsImpl_nl', 63);
...
function DateTimeFormatInfoImpl_nl(){
}

defineClass(62, 91, {}, DateTimeFormatInfoImpl_nl);
...
_.erasFull = function erasFull_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['voor Christus', 'na Christus']);
}
;
...
_.monthsFull = function monthsFull_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['januari', 'februari', 'maart', 'april', 'mei', 'juni', 'juli', 'augustus', 'september', 'oktober', 'november', 'december']);
}
;
_.monthsShort = function monthsShort_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['jan.', 'feb.', 'mrt.', 'apr.', 'mei', 'jun.', 'jul.', 'aug.', 'sep.', 'okt.', 'nov.', 'dec.']);
}
;
_.quartersFull = function quartersFull_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['1e kwartaal', '2e kwartaal', '3e kwartaal', '4e kwartaal']);
}
;
...
_.weekdaysFull = function weekdaysFull_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['zondag', 'maandag', 'dinsdag', 'woensdag', 'donderdag', 'vrijdag', 'zaterdag']);
}
;
_.weekdaysNarrow = function weekdaysNarrow_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['Z', 'M', 'D', 'W', 'D', 'V', 'Z']);
}
;
_.weekdaysShort = function weekdaysShort_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['zo', 'ma', 'di', 'wo', 'do', 'vr', 'za']);
}
;
var Lcom_google_gwt_i18n_client_impl_cldr_DateTimeFormatInfoImpl_1nl_2_classLit = createForClass('com.google.gwt.i18n.client.impl.cldr', 'DateTimeFormatInfoImpl_nl', 62);
...
setGwtProperty('permProps', [[['locale', 'nl'], ['user.agent', 'gecko1_8']]]);
