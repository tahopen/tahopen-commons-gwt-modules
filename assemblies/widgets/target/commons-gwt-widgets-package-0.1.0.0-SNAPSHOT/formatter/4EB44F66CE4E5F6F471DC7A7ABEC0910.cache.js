...
var $strongName = '4EB44F66CE4E5F6F471DC7A7ABEC0910';
var $gwt = {};
...
function $subFormat(this$static, buf, ch_0, count, adjustedDate, adjustedTime, timezone){
  ...
  switch (ch_0) {
    ...
    case 76:
      ...
      count == 5?$append_1(buf, stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['J', 'F', 'M', 'A', 'M', 'J', 'J', 'A', 'S', 'O', 'N', 'D'])[value7]):count == 4?$append_1(buf, this$static.dateTimeFormatInfo.monthsFull()[value7]):count == 3?$append_1(buf, this$static.dateTimeFormatInfo.monthsShort()[value7]):$zeroPaddingNumber(buf, value7 + 1, count);
      break;
    case 81:
...
function getFormat(predef){
  ...
  switch (predef.ordinal) {
    ...
    case 5:
      ...
      break;
    case 10:
      pattern = "EEEE d MMMM y 'kl'. HH:mm:ss zzzz";
      break;
    case 11:
      pattern = 'd MMMM y HH:mm:ss z';
      break;
    case 12:
...
function $getDateTimeFormatInfo(this$static){
  !this$static.dateTimeFormatInfo && (this$static.dateTimeFormatInfo = new DateTimeFormatInfoImpl_sv);
  return this$static.dateTimeFormatInfo;
}

function $getNumberConstants(this$static){
  !this$static.numberConstants && (this$static.numberConstants = new NumberConstantsImpl_sv);
...
function $parse_2(this$static, text_0, inOutPos){
  ...
  if ($equals(valueOnly, '\u221E')) {
   ...
   else if ($equals(valueOnly, '\xA4\xA4\xA4')) {
    inOutPos[0] += '\xA4\xA4\xA4'.length;
    ret = NaN;
  }
   else {
...
function $parseNumber(this$static, text_0, pos){
  ...
  for (; pos[0] < text_0.length; ++pos[0]) {
    ...
    if (digit >= 0 && digit <= 9) {
     ...
     else if (ch_0 == (checkCriticalStringElementIndex(0, '\xD710^'.length) , '\xD710^'.charCodeAt(0))) {
      if (sawExponent) {
        break;
      }
...
function NumberConstantsImpl_sv(){
}

defineClass(63, 1, {}, NumberConstantsImpl_sv);
var Lcom_google_gwt_i18n_client_constants_NumberConstantsImpl_1sv_2_classLit = createForClass('com.google.gwt.i18n.client.constants', 'NumberConstantsImpl_sv', 63);
...
function DateTimeFormatInfoImpl_sv(){
}

defineClass(62, 91, {}, DateTimeFormatInfoImpl_sv);
_.ampms = function ampms_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['fm', 'em']);
}
;
_.erasFull = function erasFull_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['f\xF6re Kristus', 'efter Kristus']);
}
;
_.erasShort = function erasShort_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['f.Kr.', 'e.Kr.']);
}
;
_.monthsFull = function monthsFull_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['januari', 'februari', 'mars', 'april', 'maj', 'juni', 'juli', 'augusti', 'september', 'oktober', 'november', 'december']);
}
;
_.monthsShort = function monthsShort_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['jan.', 'feb.', 'mars', 'apr.', 'maj', 'juni', 'juli', 'aug.', 'sep.', 'okt.', 'nov.', 'dec.']);
}
;
_.quartersFull = function quartersFull_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['1:a kvartalet', '2:a kvartalet', '3:e kvartalet', '4:e kvartalet']);
}
;
_.quartersShort = function quartersShort_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['K1', 'K2', 'K3', 'K4']);
}
;
_.weekdaysFull = function weekdaysFull_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['s\xF6ndag', 'm\xE5ndag', 'tisdag', 'onsdag', 'torsdag', 'fredag', 'l\xF6rdag']);
}
;
_.weekdaysNarrow = function weekdaysNarrow_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['S', 'M', 'T', 'O', 'T', 'F', 'L']);
}
;
_.weekdaysShort = function weekdaysShort_0(){
  return stampJavaTypeInfo(getClassLiteralForArray(Ljava_lang_String_2_classLit, 1), $intern_1, 2, 6, ['s\xF6n', 'm\xE5n', 'tis', 'ons', 'tors', 'fre', 'l\xF6r']);
}
;
var Lcom_google_gwt_i18n_client_impl_cldr_DateTimeFormatInfoImpl_1sv_2_classLit = createForClass('com.google.gwt.i18n.client.impl.cldr', 'DateTimeFormatInfoImpl_sv', 62);
...
function JSNumberTextFormatter(pattern){
  this.formatter = ($clinit_NumberFormat() , new NumberFormat_0(pattern, ['SEK', 'kr', 2, 'kr', 'kr']));
...
setGwtProperty('permProps', [[['locale', 'sv'], ['user.agent', 'gecko1_8']]]);
