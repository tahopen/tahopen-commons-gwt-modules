...
public class CurrencyList_fr extends com.google.gwt.i18n.client.CurrencyList_ {
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMapJava() {
    ...
    // peso colombien
    result.put("COP", new CurrencyDataImpl("COP", "$CO", 2, "COL$", "$"));
    ...
    // loti lesothan
    result.put("LSL", new CurrencyDataImpl("LSL", "lLS", 2, "lLS", "LSL"));
    // litas lituanien
    ...
    // livre turque
    result.put("TRY", new CurrencyDataImpl("TRY", "LT", 2, "YTL", "LT"));
    // dollar trinidadien
    ...
    // tala samoan
    result.put("WST", new CurrencyDataImpl("WST", "WS$", 2, "WS$", "WST"));
    // franc CFA (BEAC)
